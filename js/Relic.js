        ...
        if (this.effect) {
            switch(this.effect.type) {
                ...
                case 'magicPower':
                    ...
                    // 希沃白板之笔还有防御力加成
                    if (this.effect.def && !character.defLocked) {
                ...
                case 'weiYanYao':
                    ...
                    character.hp += 100;
                    character.def = 0;
                    character.defLocked = true;
                    character.cannotDodge = true;
                    break;
                case 'hanZhongBingFu':
                    character.maxHp += 50;
                    character.hp += 50;
                    character.hasHanZhongBingFu = true;
                    break;
                case 'adaptation':
                    character.adaptationPoints = (character.adaptationPoints || 0) + this.effect.value;
...
const RELIC_POOL = [
    ...
    { id: 42, name: '那能一样吗', description: '适应之力+5', type: 'passive', effect: { type: 'adaptation', value: 5 }, icon: '🤔', note: '"那当然不一样"' }
];
